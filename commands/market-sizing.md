---
description: "Produce a rigorous TAM/SAM/SOM analysis with top-down and bottom-up methodology"
argument-hint: "[market or product to size] [--geography REGION] [--horizon YEARS]"
allowed-tools:
  - Read
  - Write
  - Bash
