---
description: "Run a comprehensive competitive teardown with app, web, and strategic analysis"
argument-hint: "[competitor-name] [--vs YOUR_PRODUCT] [--platform ios|android|web|all]"
allowed-tools:
  - Read
  - Write
  - Bash
