---
description: "Gather app store intelligence: ratings, reviews, version history, and sentiment analysis"
argument-hint: "[app-name] [--compare competitor1,competitor2]"
allowed-tools:
  - Read
  - Write
  - Bash
