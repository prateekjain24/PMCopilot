...
3. Check for new MCP servers, skills, or agents added since the hierarchy was created:
   - New dirs under `skills/` (should have SKILL.md, not CLAUDE.md)
   - New files under `agents/`
   - New dirs under `mcp-servers/`
...
1. Component inventory matches actual counts:
   - Count skill directories: `Glob: skills/*/SKILL.md`
   - Count agent files: `Glob: agents/*.md`
   - Count MCP server dirs: `ls mcp-servers/`
